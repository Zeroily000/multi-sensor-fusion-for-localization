...
public:
    ...
    virtual void oplusImpl(const double *update) override {
        ...
        // TODO: do update
        //
        PRVAG const dprvag{update};
        _estimate.pos += dprvag.pos;
        _estimate.ori *= dprvag.ori;
        _estimate.vel += dprvag.vel;
        _estimate.b_a += dprvag.b_a;
        _estimate.b_g += dprvag.b_g;
        updateDeltaBiases(dprvag.b_a, dprvag.b_g);
    }
